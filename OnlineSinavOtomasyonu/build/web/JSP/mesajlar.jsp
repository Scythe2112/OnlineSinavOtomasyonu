...
<head>
  ...
  $(function () {
      ...
      email = $( "#txtMesaj" ).val(),
      ogr = $( "#txtMesaj" ).val(),
      allFields = $( [] ).add( name ).add( email ).add( ogr );
    ...
    $( "#dialog-form" ).dialog({
      ...
      buttons: {
        ...
        else if($("#txtOgrenci").val().length==8){
            $.ajax({
            type: "POST",
            url: 'MesajKaydet.jsp',
            data: "mesaj_Alan="+$( "#txtOgrenci" ).val()+"&mesaj_Mesaj="+$( "#txtMesaj" ).val(),
            success: function (sonuc) {
                alert(sonuc);
                $( "#dialog-form" ).dialog( "close" );
                window.location.reload();
...
<div id="dialog-form" title="Mesaj Gönder">
  ...
  <form>
  <fieldset>
      <label for="txtAlici">Personel:</label>
    ...
    <label for="txtOgrenci">Öğrenci</label>
    <input type="text" name="txtOgrenci" id="txtOgrenci" value="" size="19" />
        ...
        <div id="templatemo_wrapper">
            <div id="templatemo_main_top"></div>
               <div id="templatemo_main">
                  <div id="templatemo_sidebar">
                    <div class="sb_box">
                        <div id="contact_form">
                            ...
                            <h5><% out.print(isim+" "+soyisim); %>&nbsp;&nbsp;&nbsp;<a href="../logoutPersonel.jsp">Çıkış<img src="../icons/png/32x32/unlock.png" width="32" height="32" alt="Arama"/></a></h5>
                ...
                <div class="sb_box">
                    <table>
                        <tr><td><a href="personel.jsp"><img src="../icons/png/48x48/back.png" width="48" height="48" alt="Personel Sayfası"/><b>Personel Sayfası</b></a></td></tr>
                    </table>
                </div> 
                </div>
