...
function Arttir(soruSirasi,Ozellik_ID){
           resNesne.open('get','soruGetir.jsp?soruSirasi='+soruSirasi+'&Ozellik_ID='+Ozellik_ID+'&Durum=Arttir',true);
           resNesne.onreadystatechange=handleResponse;
           resNesne.send(null);
    
}

function soruEkleForm(){
           resNesne.open('get','soruEkleme.jsp',true);
           resNesne.onreadystatechange=handleResponse;
           resNesne.send(null);
